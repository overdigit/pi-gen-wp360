...
install -m 644 files/codesyscontrol_linuxarm64_4.22.0.0_arm64.deb "${ROOTFS_DIR}/"
install -m 644 files/codesysedge_edgearm64_4.22.0.0_arm64.deb "${ROOTFS_DIR}/"
install -m 644 files/codesysproxy_proxyarm64_4.22.0.0_arm64.deb "${ROOTFS_DIR}/"

on_chroot <<- \EOF
  dpkg -i /codemeter-lite_8.40.7131.502_arm64.deb
  dpkg -i /codesyscontrol_linuxarm64_4.22.0.0_arm64.deb
  dpkg -i /codesysedge_edgearm64_4.22.0.0_arm64.deb
  dpkg -i /codesysproxy_proxyarm64_4.22.0.0_arm64.deb
  ...
  rm /codesyscontrol_linuxarm64_4.22.0.0_arm64.deb
  rm /codesysedge_edgearm64_4.22.0.0_arm64.deb
